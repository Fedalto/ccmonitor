...
dashboard.cell = function (specs) {
  ...
  api.element = function () {
    ...
    state === 'failure' && element.append($('<div>', { 'class': 'on_it' })
      .append($('<a>', { 
        href: assignUrl,
        target: "_blank",
        html: assignedTo
    ...
    state === 'success' && element.append($('<div>', { 'class': 'on_it' })
      .append($('<a>', { 
        html: "-"
      }))
    );
    ...
    state === 'failure' && recent === false && element.css('background-color', 'rgb(' + (160-ra) + ',' + (40-ga) + ',' + (40-ba) + ')');
