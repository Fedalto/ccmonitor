...
describe("a cell", function () {
  ...
  beforeEach(function () {
    ...
    cell = dashboard.cell({name: 'AwesomeProject', state: dashboard.state.failure, 'activity': 'sleeping', 'build_type': 'quick', 'buildUrl': 'someUrl', 'recent': false, 'time_since_green':172800});
    building_cell = dashboard.cell({name: 'AwesomeProject', state: dashboard.state.failure, 'activity': 'building', 'build_type': 'quick', 'buildUrl': 'someUrl', 'recent': false, 'time_since_green':172800});
